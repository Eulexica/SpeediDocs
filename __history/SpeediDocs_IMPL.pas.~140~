...
uses
  ...
  adxolFormsManager, adxHostAppEvents, Excel_TLB, Dialogs, StdVcl,
  Forms, Windows, SaveDoc, dxCore, Matters,
  Word_TLB, Registry, Outlook2000, Outlook2010, SysUtils, cxDBData;
...
//   AddInModule: TAddInModule;
   ...
   ex2010: Excel_TLB.ExcelApplication;
...
var
   ...
   //DBW 10/09/2018 made this variable global so that it can be tested when deciding what to do with email
...
begin
   try
      ...
      try
         ...
         begin
            if dmConnection.orsInsight <> nil then
               dmConnection.orsInsight.Disconnect;
         end;
      finally
         AddInModule := nil;
...
procedure TAddInModule.adxRibbonContextMenuApptControls1Click(Sender: TObject;
  const RibbonControl: IRibbonControl);
begin   // convert outlook diary entry to bhl fee entry
   ConvertApptToFee;
end;
               ...
               begin
                  ...
                  begin
                     ...
                     try
                        ...
                        lSubject := ExcelApp.ActiveWorkbook.Name;
                     finally
                        IProps := nil;
                     end;
                  end;
         ...
         ohaWord:
               begin
                 ...
                 try
                     ...
                     lSubject := WordApp.ActiveDocument.Name;
                 finally
                     IProps := nil;
                 end;
               end;
...
//                           ShowMessage(Value);
                  ...
                  lSubject := PowerPointApp.ActivePresentation.Name;
               finally
                  IProps := nil;
               end;
            end;
