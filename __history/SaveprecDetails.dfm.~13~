object frmSavePrecDetails: TfrmSavePrecDetails
  Left = 529
  Top = 265
  AlphaBlendValue = 245
  AutoSize = True
  ...
  object dxLayoutControl1: TdxLayoutControl
    ...
    object btnTxtDocPath: TcxButtonEdit
      ...
      Properties.OnChange = btnTxtDocPathPropertiesChange
      Style.BorderColor = clWindowFrame
      Style.BorderStyle = ebs3D
      Style.HotTrack = False
      Style.ButtonStyle = bts3D
    ...
    object dxLayoutItem2: TdxLayoutItem
      ...
      AlignHorz = ahLeft
      CaptionOptions.Text = 'Precedent Name'
      Control = txtDocName
    ...
    object dxLayoutItem5: TdxLayoutItem
      Parent = dxLayoutGroup4
      AlignHorz = ahLeft
      CaptionOptions.Text = 'Precedent Group'
      Control = dblGroup
      ControlOptions.MinHeight = 19
      ControlOptions.MinWidth = 19
      ControlOptions.OriginalHeight = 21
    ...
    object dxLayoutItem9: TdxLayoutItem
      Parent = dxLayoutGroup4
      AlignHorz = ahLeft
      CaptionOptions.Text = 'cbLeaveDocOpen'
    ...
    object dxLayoutItem10: TdxLayoutItem
      Parent = dxLayoutGroup4
      AlignHorz = ahLeft
      CaptionOptions.Text = 'Precedent Path'
  ...
  object qryWorkflowType: TOraQuery
    Session = dmSaveDoc.orsInsight
    SQL.Strings = (
  ...
  object dsWorkflowType: TOraDataSource
