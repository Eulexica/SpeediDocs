...
;Filename: "{sys}\Regsvr32.exe"; Parameters: "/s SpeediDocs.dll"; WorkingDir: "{app}"; StatusMsg: "Registering component ... "; Flags: runhidden; 

[UninstallRun]
;Register components that are "special"
Filename: "{sys}\Regsvr32.exe"; Parameters: " /u /s SpeediDocs.dll"; WorkingDir: "{app}"; StatusMsg: "UnRegistering SpeediDocs... "; Flags: runhidden; 
